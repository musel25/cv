...
\leftheader{% 
  ...
  \hspace{1em}
  \makefield{\faMapMarker*}{Compiègne, France}
  \smallcaps{Mexican}\,\,\textbar\,\,\smallcaps{DoB:} 05/08/2002
}

\rightheader{~}
% \begin{fullonly}
% \photo[r]{assets/photo}
% \photoscale{0.13}
% \end{fullonly}
...
\makerubric{sections/about}
\makerubric{sections/employment}
\makerubric{sections/education}
\makerubric{sections/projects}
\makerubric{sections/skills}
\makerubric{sections/languages}
% \makerubric{sections/volunteering}
% \makerubric{referee}
% \input{sections/referee-full}
